<x-layouts.app title="Leverancier toevoegen">
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Leverancier toevoegen — {{ $product->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('products.leverancier.store', $product) }}" class="space-y-4">
                        @csrf

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Naam leverancier <span class="text-red-500">*</span></label>
                            <input type="text" name="naam" value="{{ old('naam') }}" class="{{ $f }}" required maxlength="150">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="contactpersoon" value="{{ old('contactpersoon') }}" class="{{ $f }}" maxlength="100">
                            ...
                            <div>
                                ...
                                <input type="text" name="telefoonnummer" value="{{ old('telefoonnummer') }}" class="{{ $f }}" maxlength="15">
